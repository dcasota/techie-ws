#!/bin/sh
export DOCKER_USERNAME="dcasota123"
export DOCKER_PASSWORD="Docker 2021."
export GITHUB_NODE="https://github.com/dcasota/node"
export GITHUB_PETCLINIC="https://github.com/dcasota/spring-petclinic"
